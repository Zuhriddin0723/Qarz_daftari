      ...
      appBar: AppBar(
        ...
        title: Container(
          ...
          child: TextField(
            ...
            onChanged: (value) {
              contactBlocProduct.getAllNameSearch(value);
            },
          ),
        ),
        centerTitle: true,
                                ...
                                child: Row(
                                  children: [
                                                    ...
                                                    onTap: () async {
                                                      if (controllerName.text.isEmpty ||
                                                        ...
                                                        ProductModel updateData = ProductModel(
                                                          ...
                                                          price: double.tryParse(controllerPrice.text) ?? 0,
                                                          number: int.tryParse(controllerNumber.text) ?? 0,

                                                        );
                                                        await repo.updateBase(updateData);
                                    ...
                                    InkWell(
                                      onTap: () async{
                                        RepositoryProduct repo = RepositoryProduct();
                                        await repo.deleteBaseProduct(data[index].id);
